  ...
  const data = [
    {
      title: "Who Am I",
      content:
        "I'm Kumar Ujjwal. Digital design has been an interest of mine for many years, and I work with anything from logo design to UI design and front-end development.All the skills and tools I use, are self-taught over many years of practice and expanding my horizons.",
      key: "",
    },
    {
      title: "Skills & Tools",
